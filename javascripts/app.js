...
jQuery(window).load(function() {
  ...
  if (document.getElementById('map_canvas')) {
    ...
    var gLatitude = 54.375219;
    var gLongitude = 18.6091279;
    var gZoom = 14;
    var gTitle = 'Ashtanga Yoga 3miasto';
    var gDescription = 'Ashtanga Yoga 3miasto. Szkoła jogi i zdrowego rozwoju. Ashtanga Yoga, Vinyasa Yoga, Restorative Yoga';
    ...
    var companyLogo = new google.maps.MarkerImage('images/map-pin.png',
